...
module.exports = (sequelize) => {
  const Household = sequelize.define('Household', {
    ...
    serial_number: {
      ...
      allowNull: true,
      comment: 'Serial number in ward records'
    },
    voter_id_primary: {
      type: DataTypes.STRING(20),
      allowNull: true,
      comment: 'Primary voter ID for the household'
    },
    ration_card_number: {
      type: DataTypes.STRING(20),
      allowNull: true,
    ...
    head_of_family: {
      type: DataTypes.STRING(100),
      allowNull: true,
      comment: 'Name of head of family'
    },
    aadhaar_numbers: {
      type: DataTypes.JSONB,
      allowNull: true,
      defaultValue: [],
      comment: 'Array of Aadhaar numbers for family members'
    },
    government_offices_nearby: {
      type: DataTypes.JSONB,
      allowNull: true,
      defaultValue: [],
      comment: 'Nearby government offices and landmarks'
    },
    schemes_eligible: {
      type: DataTypes.JSONB,
      allowNull: true,
      defaultValue: [],
      comment: 'Government schemes this household is eligible for'
    },
    remarks_issues: {
      type: DataTypes.TEXT,
      allowNull: true,
      comment: 'Remarks or issues in the ward related to this household'
    },
    area: {
      type: DataTypes.STRING(100),
      allowNull: true,
    ...
    ration_card_type: {
      ...
      allowNull: true,
      comment: 'APL: Above Poverty Line, BPL: Below Poverty Line, AAY: Antyodaya Anna Yojana'
    },
  ...
  Household.prototype.updateMemberCounts = async function() {
    ...
    this.adult_members = residents.filter(r => r.age >= 18 && r.age < 60).length;
  ...
  // Class methods
  Household.findByWard = function(wardNumber) {
    return this.findAll({
